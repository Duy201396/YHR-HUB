...
notis.new("<Color=White>YHDR HUB<Color=/>"):Display()
...
ImageButton1.Image = "rbxassetid://128100991809929"
...
function Tween(Pos)
    if game.Players.LocalPlayer.Character.Humanoid.Health > 0 and game.Players.LocalPlayer.Character:FindFirstChild("HumanoidRootPart") then
        ...
        baylen = game:GetService("TweenService"):Create(game.Players.LocalPlayer.Character.PartTele, TweenInfo.new(Distance / getgenv().TweenSpeed, Enum.EasingStyle.Linear),{CFrame = Pos})
        baylen:Play()
    end
end
...
DropdownFastAttackDelay:SetValue('0.175')
